/*
 * Copyright (C) Telegram Projects
*/
function Serialization(options) {
	options = options || {}
...
Serialization.prototype.createBuffer = function() {
	this.buffer = new ArrayBuffer(this.maxLength)
	this.intView = new Int32Array(this.buffer)
	this.byteView = new Uint8Array(this.buffer)
}

Serialization.prototype.getArray = function() {
...
Serialization.prototype.getBuffer = function() {
	return this.getArray().buffer
}

Serialization.prototype.getBytes = function(typed) {
	if (typed) {
		var resultBuffer = new ArrayBuffer(this.offset)
...
Serialization.prototype.checkLength = function(needBytes) {
...
Serialization.prototype.writeInt = function(i, field) {
...
Serialization.prototype.storeInt = function(i, field) {
	this.writeInt(i, (field || '') + ':int')
}

Serialization.prototype.storeBool = function(i, field) {
	if (i) {
...
Serialization.prototype.storeLongP = function(iHigh, iLow, field) {
	this.writeInt(iLow, (field || '') + ':long[low]')
	this.writeInt(iHigh, (field || '') + ':long[high]')
}

Serialization.prototype.storeLong = function(sLong, field) {
...
Serialization.prototype.storeDouble = function(f, field) {
...
Serialization.prototype.storeString = function(s, field) {
...
Serialization.prototype.storeBytes = function(bytes, field) {
...
Serialization.prototype.storeIntBytes = function(bytes, bits, field) {
	if (bytes instanceof ArrayBuffer) {
		bytes = new Uint8Array(bytes)
	}
...
Serialization.prototype.storeRawBytes = function(bytes, field) {
	if (bytes instanceof ArrayBuffer) {
		bytes = new Uint8Array(bytes)
	}
	var len = bytes.length
...
Serialization.prototype.storeMethod = function(methodName, params) {
...
Serialization.prototype.storeObject = function(obj, type, field) {
	switch (type) {
		case '#':
		case 'int':
...
function Deserialization(buffer, options) {
	options = options || {}
...
Deserialization.prototype.readInt = function(field) {
...
Deserialization.prototype.fetchInt = function(field) {
	return this.readInt((field || '') + ':int')
}

Deserialization.prototype.fetchDouble = function(field) {
	var buffer = new ArrayBuffer(8)
	var intView = new Int32Array(buffer)
	var doubleView = new Float64Array(buffer)
...
Deserialization.prototype.fetchLong = function(field) {
...
Deserialization.prototype.fetchBool = function(field) {
...
Deserialization.prototype.fetchString = function(field) {
...
Deserialization.prototype.fetchBytes = function(field) {
	var len = this.byteView[this.offset++]
...
Deserialization.prototype.fetchIntBytes = function(bits, typed, field) {
	if (bits % 32) {
...
Deserialization.prototype.fetchRawBytes = function(len, typed, field) {
	if (len === false) {
...
Deserialization.prototype.fetchObject = function(type, field) {
	switch (type) {
		case '#':
		case 'int':
...
Deserialization.prototype.getOffset = function() {
	return this.offset
}

Deserialization.prototype.fetchEnd = function() {
